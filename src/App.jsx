...
function App() {
  ...
  const [main, setMain] = useState("https://www.austinmonitor.com/wp-content/uploads/2020/10/stormy-sky-14675664419xM.jpg");
  ...
  const handleChange = (
    ...
    switch (weatherMain) {
      case "Thunderstorm":
        setMain("https://proprikol.ru/wp-content/uploads/2019/12/kartinki-pro-molniyu-i-grozu-12.jpg");
        break;
      case "Drizzle":
        setMain("https://get.pxhere.com/photo/water-sky-rain-drizzle-precipitation-drop-atmosphere-cloud-tree-photography-space-window-windshield-meteorological-phenomenon-automotive-window-part-1521117.jpg");
        break;
      case "Rain":
        setMain("https://scx2.b-cdn.net/gfx/news/hires/2018/rainstorm.jpg");
        break;
      case "Snow":
        setMain("https://vsegda-pomnim.com/uploads/posts/2023-07/1689342706_vsegda-pomnim-com-p-sneg-fon-foto-21.jpg")
        break;
      case "Atmosphere":
      ...
      case "Clear":
        ...
        break;
      case "Clouds":
        setMain("https://www.austinmonitor.com/wp-content/uploads/2020/10/stormy-sky-14675664419xM.jpg");
        break;
      default:
        setMain("https://www.austinmonitor.com/wp-content/uploads/2020/10/stormy-sky-14675664419xM.jpg");
    }
  ...
  return (
      <div style={{
        ...
        height: "100vh",
        display: "flex"}}>
          <SwitchData onChange={switchData}/>
